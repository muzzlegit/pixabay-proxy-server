...
const fetchImage = ( {  searchQuery, page, perPage  } ) => {

  const apikey = process.env.API_KEY;
  const url = `${endpoint}/?image_type=photo&orientation=horizontal&q=${searchQuery}&page=${page}&per_page=${perPage}&key=${apikey}`;
